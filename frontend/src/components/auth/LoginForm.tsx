...
const LoginForm: React.FC = () => {
  ...
  return (
    <Layout>
      {/* Hero Banner Section with login form */}
      <section className="kido-hero-banner">
        ...
        <div className="kido-hero-inner">
          ...
          <div className="kido-form-card">
            <h2>Welcome Back</h2>
            <p className="subtext">Sign in to manage your child's care dashboard.</p>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button type="submit" className="kido-btn" disabled={isLoading}>
                {isLoading ? 'Please wait…' : 'Sign In'}
              </button>
            </form>

            <p style={{ marginTop: '1.5rem', textAlign: 'center', fontSize: '0.92rem' }}>
              New to BabyCare360? <Link to="/register" style={{ color: 'var(--primary)', fontWeight: 700, textDecoration: 'none' }}>Create an account</Link>
            </p>
          </div>
        </div>
      ...
      <section style={{ maxWidth: '1280px', margin: '4rem auto', padding: '0 1.5rem' }}>
        ...
        <div className="kido-program-grid">
          ...
          <div className="kido-card kido-program-card animated-card delay-1">
            ...
            <button className="kido-circle-btn" onClick={() => navigate('/register')}>
        ...
        <div className="kido-about-grid">
          ...
          <div className="kido-about-content">
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '1rem' }}>
              <button className="kido-btn" style={{ width: 'auto', padding: '0.85rem 2rem' }} onClick={() => navigate('/register')}>Learn More</button>
